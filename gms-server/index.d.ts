declare global {
    ...
    const ms: MapScriptMethods;
    const pi: PortalPlayerInteraction;
    const qm: QuestActionManager;
    const eim: EventInstanceManager;
...
declare interface Character {
    ...
    mergeAllItemsFromPosition(statUps: Map, pos: number): void
    ...
    silentApplyDiseases(diseaseMap: Map): void
...
declare interface GameConstants {
    //============ Properties =============
    CASH_DATA: number[]
...
declare interface InformationType {
    //============ Properties =============
...
declare interface InventoryManipulator {
    //============ Properties =============
    //============ Functions  =============
...
declare interface InventoryType {
    //============ Properties =============
...
declare interface ItemInformationProvider {
    //============ Properties =============
    //============ Functions  =============
    ...
    getEquipStats(itemId: number): Map
    ...
    getSkillStats(itemId: number, playerJob: number): Map
    ...
    improveEquipStats(nEquip: Equip, stats: Map): void
...
declare interface PacketCreator {
    //============ Properties =============
    EMPTY_STATUPDATE: []
    ZERO_TIME: number
    //============ Functions  =============
    ...
    cancelMonsterStatus(oid: number, stats: Map): Packet
    ...
    closeRangeAttack(chr: Character, skill: number, skilllevel: number, stance: number, numAttackedAndDamage: number, damage: Map, speed: number, direction: number, display: number): Packet
    ...
    getKeymap(keybindings: Map): Packet
    ...
    magicAttack(chr: Character, skill: number, skilllevel: number, stance: number, numAttackedAndDamage: number, damage: Map, charge: number, speed: number, direction: number, display: number): Packet
    ...
    rangedAttack(chr: Character, skill: number, skilllevel: number, stance: number, numAttackedAndDamage: number, projectile: number, damage: Map, speed: number, direction: number, display: number): Packet
    ...
    setNPCScriptable(scriptableNpcIds: Map): Packet
    ...
    updateAriantPQRanking(playerScore: Map): Packet
...
declare interface PartyCharacter {
    //============ Properties =============
    //============ Functions  =============
    getChannel(): number
    getGuildId(): number
...
//     misc class
//=================================================================
declare interface AbstractLoadedLife { }
declare interface Alliance { }
declare interface AriantColiseum { }
declare interface AutobanManager { }
declare interface BaseService { }
declare interface BuddyAddResult { }
declare interface BuddyList { }
declare interface BuddyOperation { }
declare interface BuffStat { }
declare interface Calendar { }
declare interface CashShop { }
declare interface ChannelHandlerContext { }
declare interface ChannelServices { }
declare interface CharacterFactoryRecipe { }
declare interface CharacterIdChannelPair { }
declare interface CharactersDO { }
declare interface Coconut { }
declare interface ConfigService { }
declare interface DelayedQuestUpdate { }
declare interface Disease { }
declare interface Door { }
declare interface DoorObject { }
declare interface Dragon { }
declare interface EventScheduledFuture { }
declare interface EventScriptManager { }
declare interface Expedition { }
declare interface ExpeditionType { }
declare interface Family { }
declare interface FamilyEntry { }
declare interface Fitness { }
declare interface FootholdTree { }
declare interface GameConfigDO { }
declare interface GuardianSpawnPoint { }
declare interface Guild { }
declare interface GuildCharacter { }
declare interface GuildSummary { }
declare interface HiredMerchant { }
declare interface Hwid { }
declare interface IdleStateEvent { }
declare interface InPacket { }
declare interface InetAddress { }
declare interface InitializationVector { }
declare interface Invocable { }
declare interface ItemInformationProvider { }
declare interface JSONObject { }
declare interface KeyBinding { }
declare interface Kite { }
declare interface MCSkill { }
declare interface MakerItemCreateEntry { }
declare interface MapItem { }
declare interface MapManager { }
declare interface MapObject { }
declare interface MapObjectType { }
declare interface Marriage { }
declare interface MatchCheckerCoordinator { }
declare interface Messenger { }
declare interface MessengerCharacter { }
declare interface MiniDungeon { }
declare interface MiniGame { }
declare interface MiniGameResult { }
declare interface Mist { }
declare interface MobSkill { }
declare interface MobSkillId { }
declare interface ModifiedCashItemDO { }
declare interface Monster { }
declare interface MonsterAggroCoordinator { }
declare interface MonsterBook { }
declare interface MonsterCarnival { }
declare interface MonsterCarnivalParty { }
declare interface MonsterStatusEffect { }
declare interface Mount { }
declare interface NewYearCardRecord { }
declare interface NextLevelContext { }
declare interface Ola { }
declare interface OutPacket { }
declare interface OxQuiz { }
declare interface Packet { }
declare interface PacketProcessor { }
declare interface Pair { }
declare interface PartyOperation { }
declare interface PartySearchCoordinator { }
declare interface Pet { }
declare interface PlayerBuffStorage { }
declare interface PlayerShop { }
declare interface PlayerStorage { }
declare interface Portal { }
declare interface Pyramid { }
declare interface QuestConsItem { }
declare interface QuestStatus { }
declare interface QuickslotBinding { }
declare interface Reactor { }
declare interface Rectangle { }
declare interface ResultSet { }
declare interface Ring { }
declare interface RockPaperScissor { }
declare interface Runnable { }
declare interface SavedLocation { }
declare interface SavedLocationType { }
declare interface ScheduledFuture { }
declare interface ScriptEngine { }
declare interface ScriptedItem { }
declare interface ScrollResult { }
declare interface SkillMacro { }
declare interface SkinColor { }
declare interface Snowball { }
declare interface SoldItem { }
declare interface SpawnPoint { }
declare interface Stat { }
declare interface StatEffect { }
declare interface Status { }
declare interface Summon { }
declare interface Throwable { }
declare interface Trade { }
declare interface TypeReference { }
declare interface WeaponType { }
declare interface WorldServices { }
//=================================================================
...
declare interface EventInstanceManager {
    //============ Properties =============
    //============ Functions  =============
...
declare interface MapScriptMethods extends AbstractPlayerInteraction {
    //============ Properties =============
    //============ Functions  =============
    displayAranIntro(): void
...
declare interface NPCConversationManager extends AbstractPlayerInteraction {
    //============ Properties =============
    //============ Functions  =============
...
declare interface PortalPlayerInteraction extends AbstractPlayerInteraction {
    //============ Properties =============
    //============ Functions  =============
    blockPortal(): void
    getPortal(): Portal
...
declare interface ReactorActionManager extends AbstractPlayerInteraction {
    //============ Properties =============
    //============ Functions  =============
...
// @ts-ignore
declare interface QuestActionManager extends NPCConversationManager{
    completeQuest() : void
    dispose() : void
